...
<html class="no-js">
    ...
    <body>
        <main style="margin:auto;" class="container left-container">
            <div class="row">
                ...
                <section class="col-md-7 col-sm-12 col-md-offset-1 main-content">

                    <div class="sub-nav">
                        <a href="#" class="select-categories">Posts</a>
                    </div>

                    <div class="home-page-categories animated fadeIn ">
                        <div class="category row">
                            <section>
                                <div class="category-preview col-xs-6 col-sm-6 ">
                                    <h2 style="width:100%;">Snowing in Australia <br />
                                    <span style="font-size:12px; float:left;">16/02/2016</span> 
                                    <span style="font-size:12px; float:right; margin-right:30px;">14 Hours Ago</span> 
